...
4. `workpacks/instances/2026-02-23_feature_extension-core-architecture/00_request.md`
...
- **Workpack folder naming**: `YYYY-MM-DD_<category>_<slug>` pattern from protocol.
